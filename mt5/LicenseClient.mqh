...
// Licensing client for MT5. Add the API URL to MT5:
...
bool CheckLicenseMT5(const string api_url,
                     const string license_key,
                     const string product,
                     const int timeout_ms,
                     const string machine_id="")
  {
   string login=LongToString((long)AccountInfoInteger(ACCOUNT_LOGIN));
